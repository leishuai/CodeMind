...
AutoMind's classifiers produce structured signals with two fields that directly tell you what to do. You MUST scan for these fields in every structured artifact you read, and you MUST change your behavior based on them:
