"""Console and command helpers for the AutoMind orchestrator."""
...
def log(msg: str):
    print(f"{BLUE}[AutoMind]{NC} {msg}")


def success(msg: str):
    print(f"{GREEN}[AutoMind]{NC} {msg}")


def warn(msg: str):
    print(f"{YELLOW}[AutoMind]{NC} {msg}")


def error(msg: str):
    print(f"{RED}[AutoMind]{NC} {msg}", file=sys.stderr)
