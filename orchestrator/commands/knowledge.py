...
def cmd_workflow_check(task_code: str):
    """Check AutoMind workflow artifact continuity."""
    task_dir = get_task_dir(task_code)
...
def cmd_tick_iteration(task_code: str, phase: str = "generic") -> None:
    ...
    if pending and latest_pending_answer_matches_question(task_dir, pending) is None:
        info = {
            ...
            "nextActionPrompt": "A pending AutoMind question exists and has no recorded answer. Halt this agent turn and ask the user; record the answer with automind answer before continuing.",
        }
