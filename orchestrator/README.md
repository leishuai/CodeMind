...
This folder is required. It contains the core CodeMind loop engine used by `automind.sh` and by repair/rerun helpers.

## Responsibility

The orchestrator package owns the CodeMind task lifecycle:
