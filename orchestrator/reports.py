"""Status guidance and user-facing report manifests for CodeMind.
...
<head>
  ...
  <title>{_html(task_code)} CodeMind Report</title>
  <style>
...
<body>
<header>
  <h1>{_html(task_code)} CodeMind Report</h1>
...
def build_status_guidance(task_code: str) -> dict:
    ...
    if status == "finished":
        ...
        reason = "Human input is required before CodeMind can safely continue."
        ...
        reason = "Task is aborted; CodeMind should not resume without explicit user direction."
