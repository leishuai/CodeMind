...
<main>
  ...
  <section><h2>Lightweight Evidence Index</h2><p class="muted">Quick pointer map from evaluation.evidenceIndex[] for fast TC/signal-to-artifact lookup.</p><table><thead><tr><th>Type</th><th>Signal</th><th>TC</th><th>Path</th></tr></thead><tbody>{evidence_index_html}</tbody></table></section>
  ...
  <section><h2>Raw Artifact Appendix</h2><p class="muted">Appendix only. Primary screenshots/evidence/logs are grouped in Test Results above.</p><table><thead><tr><th>Path</th><th>Type</th><th>Bytes</th></tr></thead><tbody>{latest_html}</tbody></table></section>
