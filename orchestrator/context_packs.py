...
def _trim_to_bytes(text: str, limit: int) -> str:
    if _bytes_len(text) <= limit:
        return text
    # ASCII-heavy markdown dominates CodeMind artifacts; char slicing keeps this dependency-free.
...
def build_generator_context_pack(task_dir: Path, iteration: int, iter_log_dir: Path) -> dict:
    ...
    md_parts = [
        ...
        "",
        "This is the compact auditable task context CodeMind expects the Generator to use before editing.",
