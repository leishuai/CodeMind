...
Swift file into the CodeAutonomy task log directory so a human/agent can review it,
...
def generate_swift(flow: dict[str, Any], app_config: dict[str, Any], intent: dict[str, Any], derived_candidates: list[str] | None = None) -> str:
    ...
    header = [
        "import XCTest",
        "",
        "// Auto-generated by CodeAutonomy ios_probe_flow_materialize.py",
    ...
    lines = header + [
        ...
        '        return addUIInterruptionMonitor(withDescription: "CodeAutonomy system alert handler") { [weak self] element in',
