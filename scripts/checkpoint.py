#!/usr/bin/env python3
"""Lightweight AutoMind checkpoint manager.
...
def plan_restore(args: argparse.Namespace) -> int:
    ...
    ask = {
        ...
        "options": [
            {
                "id": "A",
                "label": "Restore AutoMind task state files only.",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="AutoMind checkpoint manager")
