#!/usr/bin/env python3
"""Shared failure classification helpers for AutoMind.
    ...
    if device_link_lost and not tests_started:
        ...
        if not link_exhausted:
            return Classification(
                ...
                "deviceLinkRetryExhausted in the failure context so AutoMind asks the user to "
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Classify AutoMind failure logs")
