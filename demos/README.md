...
AutoMind checkout. These demos are for AutoMind maintainers and users who want to
...
- Small fixtures used by AutoMind platform smoke tests.
...
- project-local AutoMind helper venv only when the selected verifier needs it.
...
The default AutoMind skill export intentionally omits `demos/`. Skill users get
