...
- Prefer project-native tests/reports, AutoMind runner/probe-flow artifacts, runtime or scoped diagnostic logs, and mock/test sink evidence before raw DB/file/state inspection.
