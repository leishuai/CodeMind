...
Run environment initialization once when AutoMind is first used in a project, or whenever the local platform/tooling state may have changed.
...
AutoMind currently targets macOS (Darwin).
